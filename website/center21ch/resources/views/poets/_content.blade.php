        ...
        <div class="body">
            ...
            <select  name="mother_language"  v-model="form.M_language" id="mother_language">
                    ...
                    <option value="Xhosa">Xhosa</option>
                                            ...
                                            <h5>
                                                    <label > About:</label>
                                                           <textarea type="text" class="form-control" rows="5" v-model="form.about"></textarea>
...
<div class="card card-default" v-else>
        <div class="form-group" >
                ...
                <label >First name: <span v-text="first_name"></span></label>
                </h5>
            <br>
                <h5>
                    <label> Last name:  <span v-text="last_name"></span> </label>
                </h5>
            <br>
                    <h5>
        ...
        <div class="footer" v-if="signedIn">
